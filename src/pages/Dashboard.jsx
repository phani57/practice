    ...
    <div className={styles.dashboardContainer}>
      <div className={styles.heroBanner}>
        <div className={styles.heroContent}>
          ...
          <p>Manage your fantasy teams and track live matches.</p>
        </div>
      ...
      {errorMessage && <div className={styles.alertCard}>{errorMessage}</div>}
        ...
        <>
          <div className={styles.statsContainer}>
            <div className={`${styles.statCard} ${styles.teams}`}>
              ...
              <div>
                <div className={styles.statTitle}>My Teams</div>

                <h2>{myTeams}</h2>

                <small>Total Fantasy Teams</small>
              </div>
            </div>
            ...
            <div className={`${styles.statCard} ${styles.matches}`}>
              ...
              <div>
                <div className={styles.statTitle}>Matches Joined</div>
            ...
            <div className={`${styles.statCard} ${styles.rank}`}>
              ...
              <div>
                <div className={styles.statTitle}>Global Rank</div>
          ...
          <div className={styles.sectionCard}>
            <div className={styles.sectionTitle}>🔴 Live Matches</div>

            {liveMatches.length === 0 ? (
              <div className={styles.emptyCard}>No Live Matches</div>
            ) : (
              liveMatches.map((match) => (
                <div className={styles.matchCard} key={match.id}>
                  <div className={styles.team}>{match.team1?.team_name}</div>
                  ...
                  <div className={styles.team}>{match.team2?.team_name}</div>
                </div>
              ))
            )}
          </div>
          ...
          <div className={styles.sectionCard}>
            ...
            {upcomingMatches.length === 0 ? (
              <div className={styles.emptyCard}>No Upcoming Matches</div>
            ) : (
